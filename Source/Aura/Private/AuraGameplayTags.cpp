...
void FAuraGameplayTags::InitializeNativeGameplayTags()
{
	...
	GameplayTags.Attributes_Primary_Resistance = UGameplayTagsManager::Get().AddNativeGameplayTag(
		FName("Attributes.Primary.Resistance"),
